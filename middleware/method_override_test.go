...
func TestMethodOverride_formParam(t *testing.T) {
	...
	m, err := MethodOverrideWithConfig(MethodOverrideConfig{Getter: MethodFromForm("_method")})
	assert.NoError(t, err)
...
func TestMethodOverride_queryParam(t *testing.T) {
	...
	m, err := MethodOverrideWithConfig(MethodOverrideConfig{Getter: MethodFromQuery("_method")})
	assert.NoError(t, err)
