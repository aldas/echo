...
func CreateJWTGoParseTokenFunc(signingKey interface{}, signingKeys map[string]interface{}) func(auth string, c echo.Context) (interface{}, error) {
...
func ExampleJWTConfig_withJWTGoAsTokenParser() {
	mw := middleware.MustJWTWithConfig(middleware.JWTConfig{
