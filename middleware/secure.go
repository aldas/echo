...
func Secure() echo.MiddlewareFunc {
	return MustSecureWithConfig(DefaultSecureConfig)
}

// MustSecureWithConfig returns a Secure middleware with config or panics on invalid configuration.
func MustSecureWithConfig(config SecureConfig) echo.MiddlewareFunc {
	mw, err := SecureWithConfig(config)
	if err != nil {
		panic(err)
	}
	return mw
...
// See: `Secure()`.
func SecureWithConfig(config SecureConfig) (echo.MiddlewareFunc, error) {
	// Defaults
